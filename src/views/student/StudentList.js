...
const StudentList = () => {
    ...
    const breadcrumbs = [{ to: '', text: 'Trang chủ' }, { to: 'students/', text: 'Học viên' },];
    return (
        <>
                ...
                <Col>
                    <Card className="h-100">
                        <Card.Body className="text-center">
                            ...
                            <NavLink to="/student/1/detail" className="mb-3 body-link">
                                Blaine Cottrell
                            </NavLink>
                            ...
                            <div className="d-flex flex-row justify-content-between w-100 w-sm-50 w-xl-100 mt-4">
                                <NavLink to="/student/:id/detail" className="btn btn-outline-primary w-100 me-1 btn-sm">
                                    Courses
                                </NavLink>
