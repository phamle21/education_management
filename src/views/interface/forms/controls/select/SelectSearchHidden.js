...
const SelectSearchHidden = () => {
  ...
  return <Select classNamePrefix="react-select" isSearchable={false} options={options} value={value} onChange={setValue} placeholder="" />;
};

export default SelectSearchHidden;
