        ...
        <>
            ...
            <div className="page-title-container">
                <Row>
                    ...
                    <Col xs="12" className="col-md d-flex align-items-start justify-content-end justify-content-lg-start">
                        <div className="me-lg-auto w-100 w-md-auto">
                ...
                !selectedCourse ?
                    ...
                    : <Row>
                        ...
                        <Col xl="12" className="mb-6">
                            <Row className="g-2">
                                <Col xs="4" xl="4" className="sh-19" onClick={() => setModalCheckPresence(true)}>
                                    <Card className="h-100 hover-scale-up">
                                        <Card.Body className="text-center">
                                            ...
                                            <div className="text-extra-small fw-medium text-muted">COURSES</div>
                                        </Card.Body>
                                    </Card>
                                </Col>
            ...
            <Modal show={modalCheckPresence} onHide={() => setModalCheckPresence(false)} size="semi-full" centered>
                ...
                <Modal.Body className='overflow-auto'>
                    <ModalListStudents setModalCheckPresence={setModalCheckPresence} />
                </Modal.Body>
            </Modal>
